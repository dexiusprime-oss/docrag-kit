...
def init(non_interactive, template):
 ...
 click.echo(f" Created {docrag_dir / 'mcp_server.py'}")
 else:
...
def config(edit):
 ...
 click.echo(" Opening configuration in editor...")
...
def doctor():
 ...
 click.echo("🔍 DocRAG Health Check\n")
 click.echo("=" * 70)

 # Check 1: DocRAG initialization
 click.echo("\n📦 Checking DocRAG initialization...")
 ...
 click.echo(" .docrag/ directory exists")
 ...
 click.echo(" Vector database exists")
 # Check size
 ...
 click.echo(" Workspace MCP config exists")
 mcp_configured = True
 try:
 import json
 ...
 click.echo(" docrag server configured")
 else:
 ...
 click.echo(" Everything looks good! DocRAG is properly configured.")
 else:
 if issues_found:
